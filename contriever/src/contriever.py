...
import torch
import transformers
from transformers import BertModel, XLMRobertaModel, DPRQuestionEncoder, DPRContextEncoder, ModernBertModel
...
class ModernBertRetriever(ModernBertModel):
    def __init__(self, config, pooling="average", **kwargs):
...
def load_retriever(model_path, pooling="average", random_init=False):
    ...
    if os.path.exists(path):
        ...
        elif "modernbert" in retriever_model_id.lower():
            model_class = ModernBertRetriever
        else:
